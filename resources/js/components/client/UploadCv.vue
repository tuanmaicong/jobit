<template>
  <div class="form-upload-check-cv">
    <div class="text-right mt-2 custom-check-cv d-flex">
      <button
        type="button"
        class="btn rounded theme-bg-light theme-cl fs-sm ft-medium btn-custom-cv mr-2"
                  ...
                  <div v-if="active == 1">
                    ...
                    <ul class="cv-choosen" v-if="cv.length != 0">
                      ...
                      >
                        ...
                        <label :htmlFor="'html' + cvs.id" class="ml-4"
                          >{{ cvs.title
                          }}<a
                    ...
                    <span v-if="cv.length == 0" class="text-danger"
                      ...
                      <a href="#">Tạo mới Cv</a> hoặc tải cv từ máy tính cá nhân
                    </span>
                  </div>
                  <div class="modal-footer">
                    <button
                      v-if="visibleLiveDemo"
                      type="submit"
